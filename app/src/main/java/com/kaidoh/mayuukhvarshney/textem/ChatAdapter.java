...
public class ChatAdapter extends BaseAdapter {
    ...
    private final List<MessageData> chatMessages;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = vi.inflate(R.layout.bubble_chat, null);
        ...
        boolean myMsg = chatMessage.getFrom() ;
        //to simulate whether it me or other sender
        setAlignment(holder, myMsg);
        holder.txtMessage.setText(chatMessage.getBody());
       // Log.d("CHatAdapter","the message is "+chatMessage.getBody());
    ...
    public void add(List<MessageData> messages) {
        chatMessages.addAll(messages);
    }

    private void setAlignment(ViewHolder holder, boolean isMe) {
        if (!isMe) {
            holder.contentWithBG.setBackgroundResource(R.drawable.purple_bubble);
